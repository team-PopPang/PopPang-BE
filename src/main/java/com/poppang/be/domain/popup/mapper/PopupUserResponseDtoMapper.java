...
public class PopupUserResponseDtoMapper {
    ...
    public List<PopupUserResponseDto> toPopupUserResponseDtoList(List<Popup> popupList, Set<Long> favoritePopupIdList) {
        ...
        for (
                var row : userFavoriteRepository.countAllByPopupIds(popupIdList)) {
        ...
        for (
                var row : popupTotalViewCountRepository.findAllViewCounts(popupUuidList)) {
        ...
        for (Popup p : popupList) {
            ...
            popupUserResponseDtoList.add(PopupUserResponseDto.builder()
                    .popupUuid(p.getUuid())
                    .name(p.getName())
